...
class MissionStatement extends Component {
    render() {
        return (
          <section id='missionStatement' className="section has-text-light has-background-black no-padding-top">
            ...
            <div className="container is-fluid">
              ...
              <div className="columns is-multiline">
                <div className="column text-is-centered">
                  ...
                  As we ride, we share the stories of those directly affected by mental health issues on our blog, capture and share our own journey via social media, and raise funds for a chraritable organization that supports mental health.
                  </p>
                </div>
                <div className="column text-is-centered">
